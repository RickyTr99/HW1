...
function modal(event){
    ...
    fetch("fetch_modal_news.php?id="+event.currentTarget.dataset.idImg).then(fetchResponse).then(fetchModalNews);
    idNews = event.currentTarget.dataset.idImg;
    fetch("fetch_commenti.php").then(fetchResponse).then(function(json){
...
function aggiungiCommento(event){
    ...
    fetch("fetch_aggiungi_commento.php?commento="+form.commento.value+"&idNews="+idNews).then(fetchResponse).then(addCommento);
}
